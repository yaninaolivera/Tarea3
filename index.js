...
console.log(`Aquí termina el ejercicio`)
...
let ordenar_por = prompt("Ingrese un valor para ordenar: (nombre, apellido, edad, profesion)")

function ordenar_lista(parametro) {
    if (typeof users[0][parametro] === "number") {
...
console.log(ordenar_lista(ordenar_por))
...
//8. Crear un boton con javascript que diga "Aceptar" y cuando se le de click mande una alerta que diga: "De acuerdo!"
    ...
    // 5. Agregar un EventListener que cuando se haga click al boton muestre un alerta con el mensaje "De acuerdo"
